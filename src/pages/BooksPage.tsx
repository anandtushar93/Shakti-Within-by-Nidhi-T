...
const paperbacks: Book[] = [
  ...
  {
    id: 103,
    title: 'Birds Coloring Book for Kids',
    series: 'Paperbacks',
    thumbnail: '/books/Birds_Coloring_Book_for_Kids.jpg',
    amazonUrl: 'https://www.amazon.com/dp/B0GLMFXBB4',
    format: 'Paperback',
    rating: 5.0,
    reviews: 'New',
    ...
    pages: '49 pages',
    description:
      'Fun and Easy Bird Coloring Pages for Early Learners Let your child explore the wonderful world of birds with this fun and easy birds coloring book made especially for young learners! This book features simple, realistic bird illustrations that help children learn bird names while developing creativity, focus, and fine motor skills. Each coloring page is printed on a single side only, with a blank page behind it to prevent marker bleed-through — perfect for crayons, colored pencils, and markers.',
